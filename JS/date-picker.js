//use show_calendar("callbcakfunctionname");
var weekend = [0,6];
...
Calendar.prototype.show = function() {
	...
	this.wwriteA("<FONT FACE='" + fontface + "' SIZE=" + fontsize + ">");
	...
	*/
	...
	for (j=vFirstDay; j<7; j++) {
		vCode = vCode + "<TD WIDTH='14%'" + this.write_weekend_string(j) + "><FONT SIZE='" + fontsize + "' FACE='" + fontface + "'>" + 
			"<A HREF='#' " + 
				"onClick=\"opener." + this.gReturnItem + "('" + 
...
function show_calendar() {
	...
	*/
	...
	if (arguments[2] == "" || arguments[2] == null)
		...
		p_year = arguments[2];
	if (arguments[3] == null)
		p_format = "DD/MON/YYYY"; // Changed by Ravish on 18/09/02 DD-MMM-YYYY
	else
		p_format = arguments[3];

	vWinCal = window.open("", "Calendar", 
		"width=200,height=180,status=no,resizable=no,top=200,left=200");
	vWinCal.opener = self;
	ggWinCal = vWinCal;
