...
\employer{\textbf{Haggle \url{www.gethaggle.com}}}
\dates{2012 - present}
\begin{position}
...
\employer{\textbf{Sales Quote Engine}}
\dates{2011-2012}
\begin{position}
...
\employer{\textbf{Go \url{www.thoughtworks-studios.com/go-continuous-delivery}}}
\dates{2009-2010}
\begin{position}
...
\employer{\textbf{Trainline \url{www.thetrainline.com}}}
...
\employer{\textbf{Healthcare Analytics for Thomson Medstat}}
\dates{2005-2008}
\begin{position}
...
\employer{\textbf{Clinical knowledge management}}
\dates{2003-2005}
\begin{position}
